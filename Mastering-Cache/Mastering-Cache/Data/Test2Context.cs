...
namespace Mastering_Cache.Data;
...
public partial class Test2Context : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<TblApplicationFlag>(entity =>
        {
            ...
            entity.HasIndex(e => e.CompanyId, "IX_tblApplicationFlag_CompanyID");
            ...
            entity.Property(e => e.FlagValue).HasMaxLength(1000);
            ...
            entity.HasOne(d => d.Company).WithMany(p => p.TblApplicationFlags)
        ...
        modelBuilder.Entity<TblPasswordPolicy>(entity =>
        {
            ...
            entity.HasIndex(e => e.CompanyId, "IX_tblPasswordPolicy_CompanyID");
            ...
            entity.HasOne(d => d.Company).WithMany(p => p.TblPasswordPolicies)
                .HasForeignKey(d => d.CompanyId)
                .OnDelete(DeleteBehavior.ClientSetNull)
